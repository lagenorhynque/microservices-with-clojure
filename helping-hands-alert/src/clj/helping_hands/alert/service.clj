...
;; Tabular routes
(def routes #{["/alerts/email" :post (conj common-interceptors `auth `core/validate
                                           `core/send-email `gen-events)
               :route-name :alert-email]
              ["/alerts/sms" :post (conj common-interceptors `auth `core/validate
...
(def service {:env :prod
              ...
              ;;  This can also be your own chain alert/server-fn -- http://pedestal.io/reference/architecture-overview#_chain_alert
              ::http/type :jetty
              ;;::http/host "localhost"
              ::http/port 8080
